...
},{"../internals/global":"hMWN","../internals/object-get-own-property-descriptor":"vuW7","../internals/create-non-enumerable-property":"LCRa","../internals/redefine":"cGjs","../internals/set-global":"LZYX","../internals/copy-constructor-properties":"R2j1","../internals/is-forced":"v8Sg"}],"A4Gh":[function(require,module,exports) {
var getBuiltIn = require('../internals/get-built-in');
...
},{"../internals/a-function":"Io0k","../internals/to-object":"DPzV","../internals/indexed-object":"C2zD","../internals/to-length":"rbgI"}],"uMb4":[function(require,module,exports) {
...
},{}],"GGHj":[function(require,module,exports) {
var userAgent = require('../internals/engine-user-agent');
...
},{"../modules/es.regexp.exec":"Pxqb","../internals/redefine":"cGjs","../internals/regexp-exec":"Dmd4","../internals/fails":"VHEc","../internals/well-known-symbol":"wid3","../internals/create-non-enumerable-property":"LCRa"}],"o1pO":[function(require,module,exports) {
'use strict';
var charAt = require('../internals/string-multibyte').charAt;
...
},{"../internals/array-buffer-view-core":"sOCC","../internals/global":"hMWN","../internals/fails":"VHEc","../internals/a-function":"Io0k","../internals/to-length":"rbgI","../internals/array-sort":"OKCz","../internals/engine-ff-version":"GGHj","../internals/engine-is-ie-or-edge":"qGFb","../internals/engine-v8-version":"q1lM","../internals/engine-webkit-version":"JG02"}],"HQxH":[function(require,module,exports) {
'use strict';
var ArrayBufferViewCore = require('../internals/array-buffer-view-core');
var toLength = require('../internals/to-length');
var toAbsoluteIndex = require('../internals/to-absolute-index');
...
new _vue.default({
  ...
  methods: {
    displayTab1: function displayTab1() {
      this.showTab1 = true;
      this.showTab2 = false;
    },
    ...
    addItemToPage: function addItemToPage(product) {
    ...
    filteredCompany: function filteredCompany() {
      this.product.brand.value = "Company 1";
    }
  },
  watch: {
    cart: function cart(products) {
  ...
  computed: {
    ...
    filteredProducts: function filteredProducts() {
      ...
      return this.products.filter(function (product) {
        return product.name.toLowerCase().match(_this2.searchName.toLowerCase()) || product.model.toLowerCase().match(_this2.searchName.toLowerCase());
      });
    }
  }
});
},{"core-js/stable":"n4uP","regenerator-runtime/runtime":"VuXv","vue/dist/vue":"B7lj"}]},{},["Y5Mt"], null)